...
{
    [System.Serializable]
    public abstract class CorruptedAxisCommand : CorruptedModel
    {


        public abstract void StartExecute();

        public abstract void WhileExecute(float axis);
    ...
    [System.Serializable]
    public abstract class CorruptedAxisCommand<T> : CorruptedModel
    {


        public abstract void StartExecute(T t);

        public abstract void WhileExecute(T t, float axis);
